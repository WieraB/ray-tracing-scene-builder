...
// No backtracking line search is employed here.
...
struct Quadratic_tet {
    ...
    const int face_indices[4][6] = {
      ...
      // Correct numbering for the mesh generated by NGSolve/Netgen
      // const int face_indices[4][6] = {
          ...
          bool intersect = false;
            ...
            for (int f = 0; f < 4; ++f) {
                ...
                for (int iter = 0; iter < iter_max; ++iter) {
                    ...
                    // Eigen::Vector2d delta = M.inverse() * (-J_F);
...
int main(int argc,char *argv[]){
  ...
  if(argc >= 3) loadSpheres(argv[2], spheres);
   ...
   Mesh mesh;
   mesh.loadVolFile("one_tet_3.vol");
